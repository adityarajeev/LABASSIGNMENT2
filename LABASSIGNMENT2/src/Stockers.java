...
public class Stockers {
	public static void main(String[] args) {
		...
		Stockers stc=new Stockers();
		stc.sortMe(price,0,num-1);
		...
		while(n!=0)
		{
			...
			if(n==5) {
				...
				if(point>=1)
					System.out.println("Stock of value "+s+" is present at "+m);
				else
	...
	public void merg(double price[], int l, int m, int r)
	    {
	        int n1 = m - l + 1;
	        int n2 = r - m;
	...
	public void sortMe(double price[], int l, int r)
	    {
	        if (l < r) {
	            int m =l+ (r-l)/2;
	            sortMe(price, l, m);
